...
<div class="content-wrapper">
    ...
    <!-- Green Box-->
     <!--For Bill Amount-->
        ...
        <h4><i class="icon fa fa-money"></i> Total Bill Amount</h4>
          ...
          //print_r($row3); exit;
          ?>
         <center><font size="5"> TK. <?php echo $row3['subtotal'];?></font></center>
          </div>
           <!--For Bill Amount End-->
        ...
        //print_r($row3); exit;
        ?>
        <center><font size="5"> TK. <?php echo $row4['depositammount'];?></font></center>
        </div>
   <!--For Deposit End-->
   ...
   <div class="alert alert-success alert-dismissible" style="height: 80px;">
        ...
        <center><font size="5"> TK.<?php echo $r1;?></font>
        </center>
           </div>
 <!--For Due Amount End-->
    <!-- Green Box End-->
