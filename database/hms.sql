...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2023 at 01:48 PM
...
CREATE TABLE `expensess` (
  `id` int(7) NOT NULL,
  `doctor_salary` varchar(20) NOT NULL,
  `electricty_bil` varchar(15) NOT NULL,
  `hospital_reant` varchar(45) NOT NULL,
...
INSERT INTO `expensess` (`id`, `doctor_salary`, `electricty_bil`, `hospital_reant`, `exp_id`) VALUES
(1, '3500', '1200', '', '');
...
(1, 'download.jpg', 'shagor', 'akon', 'admin@admin.com', '202cb962ac59075b964b07152d234b70');
